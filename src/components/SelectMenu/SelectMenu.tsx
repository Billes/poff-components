          ...
          <Listbox.Options className='absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm'>
            {options.map((option) => (
              <Listbox.Option
                ...
                className='ui-not-active:text-blackgray-900 ui-active:bg-sky-600 ui-active:text-white ui-not-active:bg-white relative flex cursor-default select-none items-center py-2 pl-8 pr-4'
                value={option}
